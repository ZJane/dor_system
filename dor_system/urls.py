...
from dor.admin_handle.device_handle import admin_resource, borrow_minitor_applyments, borrow_key_applyments, \
    commit_return_device
from dor.admin_handle.repair_handle import admin_repair, handle_DorRepairDevice_applyments
from dor.student_handle.device_repair_applyment import repair, show_device_repair_applyments, \
